...
class DrawBest(object):
    ...
    def __init__(self, sdBest:BestList, dxBest:BestList, userName:str):
        ...
        self.pic_dir = './data/static/mai/pic/'
        self.cover_dir = './data/static/mai/cover/'
    ...
    def _drawBestList(self, img:Image.Image, sdBest:BestList, dxBest:BestList):
        ...
        titleFontName = './data/static/adobe_simhei.otf'
        for num in range(0, len(sdBest)):
            ...
            font = ImageFont.truetype('./data/static/adobe_simhei.otf', 12, encoding='utf-8')
            tempDraw.text((8, 44), f'Base: {chartInfo.ds} -> {computeRa(chartInfo.ds, chartInfo.achievement)}', 'white', font)
            font = ImageFont.truetype('./data/static/adobe_simhei.otf', 18, encoding='utf-8')
    ...
    def draw(self):
        ...
        font1 = ImageFont.truetype('./data/static/msyh.ttc', 28, encoding='unic')
        ...
        font2 = ImageFont.truetype('./data/static/adobe_simhei.otf', 14, encoding='utf-8')
